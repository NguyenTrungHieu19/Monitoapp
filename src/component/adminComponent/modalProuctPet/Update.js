...
const ModalUpdateProductPet = () => {
    const { openModalUpProductPet,setOpenModalUpProductPet } = useContext(ProductPetModalContext);
    const handleClose = () => {
    ...
    return (
        <>
            <Modal title="Create Menu" open={openModalUpProductPet} onOk={handleClose} onCancel={handleClose}>
