...
const ModalUpdateProductFood = () => {
    const { openModalUpProductFood,setOpenModalUpProductFood } = useContext(ProductFoodContext);
    const handleClose = () => {
        setOpenModalUpProductFood(false);
    };
    ...
    return (
        <>
            <Modal title="Create Menu" open={openModalUpProductFood} onOk={handleClose} onCancel={handleClose}>
...
export default ModalUpdateProductFood;