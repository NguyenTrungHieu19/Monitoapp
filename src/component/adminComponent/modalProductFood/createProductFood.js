...
const ModalCreateProductFood = () => {
    const { openModalCreateProductFood,setOpenModalCreateProductFood } = useContext(ProductFoodContext);
    const handleClose = () => {
        setOpenModalCreateProductFood(false);
    };
    ...
    return (
        <>
            <Modal title="Create Menu" open={openModalCreateProductFood} onOk={handleClose} onCancel={handleClose}>
...
export default ModalCreateProductFood;